...
from timberborn_power_mix.simulation.models import SimulationConfig, FactoryConfig, EnergyMixConfig
...
def run_profiled_simulation():
    ...
    num_iterations = 5
    print(f"Starting Scalene profiling ({num_iterations} iterations of {config.samples:,} samples)...")
