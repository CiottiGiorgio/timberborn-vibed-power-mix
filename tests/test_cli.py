...
def test_simulate_no_options():
    ...
    with patch("timberborn_power_mix.simulation.orchestrator.simulation_orchestrator") as mock_orchestrator, \
...
def test_optimize_no_options():
    ...
    with patch("timberborn_power_mix.optimization.orchestrator.optimization_orchestrator") as mock_orchestrator:
