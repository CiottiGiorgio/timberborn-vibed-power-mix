...
from timberborn_power_mix.models import SimulationOptions, SimulationResult
...
def simulate_scenario(params: SimulationOptions, rng_service=None):
    # Consumption
    ...
    total_battery_capacity = num_batteries * battery_capacity(battery_height)
    ...
    # Season boundaries for plotting
    season_boundaries = []
    curr_day = 0
    ...
    worst_run_data = SimulationResult(
        ...
        power_consumption=batch_res.aggregated_samples.power_consumption,
